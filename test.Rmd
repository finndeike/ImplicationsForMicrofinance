...
##Vielleicht besser Data-Frame und Risk Categorys ergänzen
...
##teilweise inkorrekte Werte, was ist mit itczero?
...
reg4_1 <- lm(loansize ~ offer4, data = filter(stata_data, offer4==final4, tookup_afterdead_enforced == 0))

stargazer(reg4_1, type="html", header = FALSE)
```
