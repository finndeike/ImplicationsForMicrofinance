...
showreg(list("(3)"=reg3_3), coef.transform=c("mfx"), omit.coef = "(Intercept)", digits=3)
...
showreg(list("(7)"=reg3_7,"(8)"=reg3_8, "(9)"=reg3_9), coef.transform=c("mfx", "mfx", "mfx"), omit.coef = "(Intercept)", digits=3)
...
Here we encounter an alleged point of criticism of micro credits. It is often assumed that for lenders the best strategy for profit maximization is to charge horrendous interest rates. Which seems logical at first sight. We want to evaluate this assumption and answer the question hwether the lender should raise or cut offer rates.
...
Our estimation suggests that the lender nether a loan price cut or raise offers an incentive for the lender.

### Targeted 

```{r "5.1.5", warning=FALSE, results='asis'}
#< task_notest
dat <- dat %>% mutate(grossincomesq = grossincome^2, agesq = age^2, appscoresq = appscore^2, itcscoresq = itcscore^2, sales_netincomesq = sales_netincome^2, sales_grossincomesq = sales_grossincome^2)
