...
```{r "4 a) 1", error=FALSE, results='asis'}
#< task_notest
reg3_1 <- bife(applied ~ offer4 | low, med, waved2, waved3 ,  model="probit", data=filter(stata_data, normrate_less == 1))

summary(reg3_1)
#>
```

```{r "4 a) 2", error=FALSE, results='asis'}
#< task_notest
...
```{r "4 a) 3", error=FALSE, results='asis'}
#< task_notest
