...
1.6) Replace the question marks with the missing values and functions to create a box plot of distribution of the offer rate for each risk category. If you think your answer is right press the `Check` button.
```{r "3_6"}
# dat %>%
...
```{r "4_18",error=FALSE, results='asis'}
...
```{r "6_23",error=FALSE, results='asis'}
...
```{r "6_24",error=FALSE, results='asis'}
...
```{r "6_26",error=FALSE, results='asis'}
...
```{r "6_27",error=FALSE, results='asis'}
...
```{r "7_30",warning=FALSE, results='asis'}
...
```{r "7_31",warning=FALSE, results='asis'}
...
```{r "7_32",warning=FALSE, results='asis'}
...
```{r "7_33",warning=FALSE, results='asis'}
...
```{r "8_35",warning=FALSE, results='asis'}
...
```{r "8_36",warning=FALSE, results='asis'}
...
```{r "8_37",warning=FALSE, results='asis'}
